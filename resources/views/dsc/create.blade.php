...
@section('content')
<h3 class="text-center">CREAR NUEVA DECLARACION</h3><br>
{!!Form::open(['route'=>'dsc.store','method'=>'POST','class'=>'form-horizontal form-label-left x_content'])!!}
    ...
    <div class="form-group">
      <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-5">{!!Form::submit('Guardar Declaracion',['class'=>'col-md-5 btn col-xs-12 btn-success'])!!}</div>
    </div>
